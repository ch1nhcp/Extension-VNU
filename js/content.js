...
if ($("#s2id_autogen1").length === 0 && $("div.alert.alert-danger.alert-dismissable").length !== 0) {
    ...
    var App = function () {
        var n = function () {
            jQuery("body").on("click", ".ajax-loading", function (n) {
                n.preventDefault();
                var t = $(".tab-content"), i = jQuery(this).attr("data-url"), r = $(this).attr("data-error-display");
                i ? (App.blockUI({target: t}), $.ajax({
                    type: "GET",
                    cache: !1,
                    url: i,
                    dataType: "html",
                    ...
                    error: function () {
                        ...
                        r == "toastr" && toastr ? toastr.error(n) : r == "notific8" && $.notific8 ? ($.notific8("zindex", 11500), $.notific8(n, {
                            theme: "ruby",
                            life: 3e3
                        })) : alert(n)
                    }
                })) : (App.blockUI({target: t}), window.setTimeout(function () {
                    App.unblockUI(t)
                }, 1e3))
            })
        };
        return {
            init: function () {
                ...
                var n = $.extend(!0, {}, n), t = "", i;
                t = n.iconOnly ? '<div class="loading-message ' + (n.boxed ? "loading-message-boxed" : "") + '"><img style="" src="../Images/ajax-modal-loading.gif" align=""><\/div>' : n.textOnly ? '<div class="loading-message ' + (n.boxed ? "loading-message-boxed" : "") + '"><span style="color:#fff;">&nbsp;&nbsp;' + (n.message ? n.message : "Vui lòng đợi...") + "<\/span><\/div>" : '<div class="loading-message ' + (n.boxed ? "loading-message-boxed" : "") + '"><img style="" src="../Images/ajax-modal-loading.gif" align=""><span style="color:#fff;">&nbsp;&nbsp;' + (n.message ? n.message : "Vui lòng đợi...") + "<\/span><\/div>";
                n.target ? (i = jQuery(n.target), i.height() <= $(window).height() && (n.cenrerY = !0), i.block({
                    message: t,
                    baseZ: n.zIndex ? n.zIndex : 1e3,
                    centerY: n.cenrerY != undefined ? n.cenrerY : !1,
                    css: {top: "50%", border: "0", padding: "0", backgroundColor: "none"},
                    overlayCSS: {
    ...
    !function () {
        ...
        function n(n) {
            function o(o, s) {
                ...
                if (s = n.extend({}, n.blockUI.defaults, s || {}), !s.ignoreIfBlocked || !n(o).data("blockUI.isBlocked")) {
                    ...
                    if (c && (s.theme ? w.find(".ui-widget-content").append(c) : w.append(c), (c.jquery || c.nodeType) && n(c).show()), (e || s.forceIframe) && s.showOverlay && tt.show(), s.fadeIn) {
                        var lt = s.onBlock ? s.onBlock : f, vt = s.showOverlay && !c ? lt : f, yt = c ? lt : f;
                        s.showOverlay && nt._fadeIn(s.fadeIn, vt);
                        c && w._fadeIn(s.fadeIn, yt)
                    } else s.showOverlay && nt.show(), c && w.show(), s.onBlock && s.onBlock();
                    (h(1, o, s), p ? (t = w[0], i = n(s.focusableElements, t), s.focusInput && setTimeout(l, 20)) : v(w[0], s.centerX, s.centerY), s.timeout) && (at = setTimeout(function () {
                        p ? n.unblockUI(s) : n(o).unblock(s)
                    }, s.timeout), n(o).data("blockUI.timeout", at))
                }
            }
            ...
            function u(r, u) {
                ...
                h(0, r, u);
                null === u.onUnblock && (u.onUnblock = e.data("blockUI.onUnblock"), e.removeData("blockUI.onUnblock"));
            ...
            function s(t, i, r, u) {
                ...
                if (!f.data("blockUI.isBlocked")) {
                    ...
                    i && i.el && (i.el.style.display = i.display, i.el.style.position = i.position, i.parent && i.parent.appendChild(i.el), f.removeData("blockUI.history"));
                    f.data("blockUI.static") && f.css("position", "static");
                    "function" == typeof r.onUnblock && r.onUnblock(u, r);
                    var e = n(document.body), o = e.width(), s = e[0].style.width;
                    e.width(o - 1).width(o);
                    e[0].style.width = s
                }
            }
            ...
            function c(r) {
                var u, f;
                if ("keydown" === r.type && r.keyCode && 9 == r.keyCode && t && r.data.constrainTabKey) {
                    var e = i, s = !r.shiftKey && r.target === e[e.length - 1], o = r.shiftKey && r.target === e[0];
                    if (s || o) return setTimeout(function () {
                        l(o)
                    }, 10), !1
                }
                return u = r.data, f = n(r.target), f.hasClass("blockOverlay") && u.onOverlayClick && u.onOverlayClick(r), f.parents("div." + u.blockMsgClass).length > 0 ? !0 : 0 === f.parents().children().filter("div.blockUI").length
            }
            ...
            var f = n.noop || function () {
                ...
                y = (document.documentMode || 0, n.isFunction(document.createElement("div").style.setExpression));
            ...
            n.growlUI = function (t, i, r, u) {
                var f = n('<div class="growlUI"><\/div>'), e;
                t && f.append("<h1>" + t + "<\/h1>");
                i && f.append("<h2>" + i + "<\/h2>");
                void 0 === r && (r = 3e3);
                e = function (t) {
            ...
            n.fn.block = function (t) {
                ...
                return this.each(function () {
                    ...
                    "static" == n.css(this, "position") && (this.style.position = "relative", n(this).data("blockUI.static", !0));
                    this.style.zoom = 1;
                    o(this, t)
                })
            };
    ...
    "function" != typeof Object.create && (Object.create = function (n) {
        ...
        var i = {
            init: function (t) {
                return this.options = n.extend({}, n.noty.defaults, t), this.options.layout = this.options.custom ? n.noty.layouts.inline : n.noty.layouts[this.options.layout], n.noty.themes[this.options.theme] ? this.options.theme = n.noty.themes[this.options.theme] : t.themeClassName = this.options.theme, delete t.layout, delete t.theme, this.options = n.extend({}, this.options, this.options.layout.options), this.options.id = "noty_" + (new Date).getTime() * Math.floor(1e6 * Math.random()), this.options = n.extend({}, this.options, t), this._build(), this
            }, _build: function () {
                var t = n('<div class="noty_bar noty_type_' + this.options.type + '"><\/div>').attr("id", this.options.id),
                    i, r;
                (t.append(this.options.template).find(".noty_text").html(this.options.text), this.$bar = null !== this.options.layout.parent.object ? n(this.options.layout.parent.object).css(this.options.layout.parent.css).append(t) : t, this.options.themeClassName && this.$bar.addClass(this.options.themeClassName).addClass("noty_container_type_" + this.options.type), this.options.buttons) && (this.options.closeWith = [], this.options.timeout = !1, i = n("<div/>").addClass("noty_buttons"), null !== this.options.layout.parent.object ? this.$bar.find(".noty_bar").append(i) : this.$bar.append(i), r = this, n.each(this.options.buttons, function (t, i) {
                    var u = n("<button/>").addClass(i.addClass ? i.addClass : "gray").html(i.text).attr("id", i.id ? i.id : "button-" + t).appendTo(r.$bar.find(".noty_buttons")).bind("click", function () {
                ...
                return t.options.custom ? t.options.custom.find(t.options.layout.container.selector).append(t.$bar) : n(t.options.layout.container.selector).append(t.$bar), t.options.theme && t.options.theme.style && t.options.theme.style.apply(t), "function" === n.type(t.options.layout.css) ? this.options.layout.css.apply(t.$bar) : t.$bar.css(this.options.layout.css || {}), t.$bar.addClass(t.options.layout.addClass), t.options.layout.container.style.apply(n(t.options.layout.container.selector)), t.showing = !0, t.options.theme && t.options.theme.style && t.options.theme.callback.onShow.apply(this), n.inArray("click", t.options.closeWith) > -1 && t.$bar.css("cursor", "pointer").one("click", function (n) {
                    ...
                    t.stopPropagation(n);
                    t.close()
                }), -1 == n.inArray("button", t.options.closeWith) && t.$closeButton.remove(), t.options.callback.onShow && t.options.callback.onShow.apply(t), t.$bar.animate(t.options.animation.open, t.options.animation.speed, t.options.animation.easing, function () {
                ...
                if (!(this.closed || this.$bar && this.$bar.hasClass("i-am-closing-now"))) {
                    if (t = this, this.showing) return t.$bar.queue(function () {
                        t.close.apply(t)
                    }), void 0;
                    if (!this.shown && !this.showing) return i = [], n.each(n.noty.queue, function (n, r) {
                        r.options.id != t.options.id && i.push(r)
                    }), n.noty.queue = i, void 0;
                    ...
                    t.$bar.clearQueue().stop().animate(t.options.animation.close, t.options.animation.speed, t.options.animation.easing, function () {
                        ...
                        t.options.modal && (n.notyRenderer.setModalCount(-1), 0 == n.notyRenderer.getModalCount() && n(".noty_modal").fadeOut("fast", function () {
                            n(this).remove()
                        }));
                        ...
                        t.options.dismissQueue || (n.noty.ontap = !0, n.notyRenderer.render());
        ...
        n.notyRenderer.init = function (t) {
            ...
            return r.options.killer && n.noty.closeAll(), r.options.force ? n.noty.queue.unshift(r) : n.noty.queue.push(r), n.notyRenderer.render(), "object" == n.noty.returns ? r : r.options.id
        };
        n.notyRenderer.render = function () {
            var t = n.noty.queue[0];
            "object" === n.type(t) ? t.options.dismissQueue ? t.options.maxVisible > 0 ? n(t.options.layout.container.selector + " li").length < t.options.maxVisible && n.notyRenderer.show(n.noty.queue.shift()) : n.notyRenderer.show(n.noty.queue.shift()) : n.noty.ontap && (n.notyRenderer.show(n.noty.queue.shift()), n.noty.ontap = !1) : n.noty.ontap = !0
        };
        n.notyRenderer.show = function (t) {
            t.options.modal && (n.notyRenderer.createModalFor(t), n.notyRenderer.setModalCount(1));
        ...
        n.notyRenderer.createModalFor = function (t) {
            0 == n(".noty_modal").length && n("<div/>").addClass("noty_modal").data("noty_modal_count", 0).css(t.options.theme.modal.css).prependTo(n("body")).fadeIn("fast")
        };
        ...
        n.noty.layouts.bottomCenter = {
            ...
            container: {
                ...
                style: function () {
                    ...
                    n(this).css({left: (n(window).width() - n(this).outerWidth(!1)) / 2 + "px"})
                }
            },
            parent: {object: "<li />", selector: "li", css: {}},
        ...
        n.noty.layouts.centerLeft = {
            ...
            container: {
                ...
                style: function () {
                    ...
                    i = t.height();
                    t.remove();
                    n(this).hasClass("i-am-new") ? n(this).css({top: (n(window).height() - i) / 2 + "px"}) : n(this).animate({top: (n(window).height() - i) / 2 + "px"}, 500);
                    window.innerWidth < 600 && n(this).css({left: 5})
                }
            },
            parent: {object: "<li />", selector: "li", css: {}},
                ...
                borderFix: function () {
                    if (this.options.dismissQueue) {
                        ...
                        switch (this.options.layout.name) {
                            ...
                            case"inline":
                                n(t).css({borderRadius: "0px 0px 0px 0px"});
                                n(t).first().css({"border-top-left-radius": "5px", "border-top-right-radius": "5px"});
                                n(t).last().css({
    ...
    function completeCallback2() {
        $registrationAvailable == "false" && ($(".abort").remove(),
            $(".chk-brc").remove(),
        $n != null && $n.close(),
    ...
    $(document).on("click", ".order", function () {
        ...
        if (App.blockUI(), n = "", $(this).is(":checked")) {
            ...
            if (n = t < u + f ? "Bạn đã chọn quá số tín chỉ được phép đăng ký!\nSố tín chỉ tối đa được phép đăng ký là: " + t : CheckPrerequisite(i),
            n == "")
                if (n = Pending(r),
                n == "")
                    DSDK($(".sel-dsdk-mod")[0].value);
    ...
    $(document).on("click", ".chk-brc", function () {
        ...
        i ? ($n != null && $n.close(),
            showNoty("Bạn đã thay đổi môn học. Các thay đổi này chỉ thực sự được ghi nhận sau khi bạn bấm nút Ghi nhận!", "warning", "bottom")) : $(this).prop("checked", !t);
        App.unblockUI()
    });
}
...
function kq(n) {
    var msg = n && n.message || '';
    if (dsfull.length > 0) msg += '\nMôn học [' + dsfull.join('; ') + '] đã full, vui lòng thay bằng mã số môn học tương ứng để đăng ký.';
    dsfull = [];
    $("#resultAuto")
        .html(msg);
    DSDK($(".sel-dsdk-mod")
...
function fastDK() {
    ...
    subarr.forEach(function (sj) {
        ...
        if (tdsj && tdsj.parentElement.firstElementChild.firstElementChild)
            Pending(tdsj.parentElement.firstElementChild.firstElementChild.dataset.rowindex);
        else dsfull.push(sj);
    });
    if (document.querySelector('#gnflag')
        .checked) ajaxRequest(
        "POST",
...
function spamSubmitInterval() {
    $("#resultAuto")
        .html('Đang ghi nhận...');
    ajaxRequest("POST", "/xac-nhan-dang-ky/" + $registrationMode, "json", spamSubmitComplete, null, null, !0);
}
...
function spamSubmit() {
    if (autoInterval) {
        ...
        var timeAuto = $("#timeAuto")
            .val() * 1000;
        autoInterval = setInterval(spamSubmitInterval, timeAuto < 1000 ? 1000 : timeAuto);
        $("#spamSubmit")
            .attr("class", "btn btn-danger");
        $("#spamSubmit")
            .html("Stop");
        $("#resultAuto")
            .html('Bắt đầu spam submit..')
    }
}
